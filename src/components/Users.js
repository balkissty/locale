            ...
            <div className="flex justify-center">
                <div className="mb-3 xl:w-96">
                    <div className="input-group mt-10 justify-end flex items-stretch w-full mb-4">
                        ...
                        <button className="btn px-6 py-2.5 bg-indigo-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center" type="button" id="button-addon2">
                            ...
                            <div className="overflow-hidden">
                                ...
                                <tbody>
                                    {contacts.filter((contacts) => {
                                        if (search === "") {
                                            return contacts
                                        } else if (contacts.first_name.toLowerCase() && contacts.last_name.toLowerCase() && 
                                                    contacts.email.toLowerCase().includes(search.toLowerCase())) {
                                            return contacts
                                        }
                                    }).map((user) => (
                                        <tr className="border-b odd:bg-white even:bg-indigo-100" key={user.id}>
